...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    correction: Schema.Attribute.Relation<'oneToOne', 'api::resource.resource'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    type: Schema.Attribute.Enumeration<
      ['Cours', 'Examens', 'TP', 'TD', 'Correction', 'Projet']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSubjectSubject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    semester: Schema.Attribute.Enumeration<['Semestre 1', 'Semestre 2']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
